...
namespace RogueChess.UI
{
    public partial class LegendForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text =
                    "Scorched Tile - Applies burning status to pieces that enter or start their turn on it",
            ...
            {
                Text =
                    "Slippery Tile - Forces pieces to slide one extra step in their movement direction",
                Font = new Font("Arial", 10),
                AutoSize = true,
            ...
            {
                Text =
                    "Orange Border - Exploding Piece - Explodes when captured, affecting surrounding tiles",
                Font = new Font("Arial", 10),
                AutoSize = true,
            ...
            {
                Text =
                    "Red Dot (●) - Status Effect Piece - Can carry and process status effects like Burning",
                Font = new Font("Arial", 10),
                AutoSize = true,
            ...
            {
                Text =
                    "Blue Cross (✚) - Martyr Piece - Sacrifices itself to protect adjacent friendly pieces",
                Font = new Font("Arial", 10),
                AutoSize = true,
            ...
            {
                Text =
                    "Burning - Piece takes damage each turn and may be destroyed\n"
            ...
            {
                Text =
                    "♟️ Standard Chess - Traditional chess with standard pieces and no special effects\n"
